...
from utils import LOSS_evaluate, evaluator
...
input_dir = r'E:\日志解析-大修\BigData'
output_dir = 'LogSer_BigData_results'
bechmark_result = []
if __name__ == '__main__':
    for dataset in benchmark_settings.keys():
        print('1')
        if dataset not in {'BGL'}:
            continue
    ...
    print(df_result)
    df_result.to_csv('LogSer_BidData_result.csv')